...
let anosIdade = parseInt(prompt("Informe quantos anos completos voce tem: "));

let mesesIdade = parseInt(prompt("Informe quantos meses se passaram desde o seu último aniversário"));

let diasIdade = parseInt(prompt("Informe quantos dias se passaram desde que voce completou mais um mes após seu aniversário"));
