...
console.log(`O terceiro caractere do nome Anael é: ${terceiroCaractere}`);
...
let stringFrutas = "Maça, Banana, Laranja ";
...
let stringFrutas2 = "Maça, Banana, Laranja";
...
//Exemplo do método subtr()
let stringFrutas3 = "Maça, Banana, Laranja";
...
let primeiroNome = "Anael";
let segundoNome = "Souza";
let nomeCompleto = primeiroNome.concat(" ", segundoNome);

let nomeCompletoLoweCase = nomeCompleto.toLowerCase();
let nomeCompletoUpperCase = nomeCompleto.toUpperCase();

console.log(nomeCompletoLoweCase);
...
const arrayTextoComSplit2 = arrayTextoSemSplit2.split("");
