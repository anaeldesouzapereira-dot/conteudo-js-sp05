//Operadores de  operadores de comparação

//Cpmparador de igualdade ==
let a = 3;
...
let exNaoIgualValor1 = d !==8;
let exNaoIgualValor2 = d !==1;
let exNaoIgualValor3 = d !== "8";

console.log("d não é igual ao valor e ao tipo de 8?: " + exNaoIgualValor1);
console.log("d não é igual ao valor e ao tipo de 1?: " + exNaoIgualValor2);
console.log("d não é igual ao valor e ao tipo de '8'?: " + exNaoIgualValor3);
...
if (idade > 17) aviso = "Voce já pode dirigir";
